...
def load():
    ...
    # Load the game music
    music = pygame.mixer.music.load('assets/sounds/magic-in-the-air.mp3')

    # Load small font for FPS
    small_font = pygame.font.Font('assets/fonts/font.ttf', 14)
...
def init():
    ...
    stateManager.changeState(MenuState(stateManager))
...
def render(dt):
    ...
    display_fps(virtual_screen, small_font, int(clock.get_fps()))
