...
class GameOverState(State):
    ...
    def render(self, virtual_screen, dt=0.0):
        ...
        draw_text('Game Over', self.titleFont, VIRTUAL_WIDTH / 2,
                  VIRTUAL_HEIGHT / 4, (255, 255, 255), virtual_screen)
        draw_text('Play Again', self.buttonFont, VIRTUAL_WIDTH / 2,
        ...
        draw_text('>', self.buttonFont, VIRTUAL_WIDTH / 2 - 85, VIRTUAL_HEIGHT /
