...
#--------------------------------------------------------------------------
    ...
    def __init__(self, x, y, radius, paddle1, paddle2):
        self.x = x
        self.y = y
        self.radius = radius
...
#--------------------------------------------------------------------------
    ...
    def update(self, dt):
        ...
        elif self.y >= VIRTUAL_HEIGHT - self.radius:
        ...
        # Check collision with the second paddle
            ...
            # Reset the position and change the direction
            self.x = self.paddle2.x - self.radius
...
#--------------------------------------------------------------------------
    ...
    def checkCollision(self, rect):
        ...
        if self.x > rect.x + rect.width or self.x + self.radius < rect.x:
            return False

        # Then check to see if the bottom edge of either is higher than the top
        # edge of the other
        if self.y > rect.y + rect.height or self.y + self.radius < rect.y:
            return False
...
#--------------------------------------------------------------------------
    ...
    def render(self, screen):
        ...
        '''
        pygame.draw.circle(screen, Ball.COLOR, (self.x, self.y), self.radius)
